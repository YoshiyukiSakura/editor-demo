...
var SuggestionsWrapper = styled__default["default"].ul(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  position: absolute;\n  min-width: 180px;\n  padding: 16px;\n  margin: 20px 0 0;\n  list-style: none;\n  cursor: pointer;\n  background: #fff;\n  border: 1px solid #c8ccd0;\n  border-radius: 3px;\n  box-shadow: 0 1px 5px rgba(27, 31, 35, .15);\n  color: #506176;\n\n  li {\n    padding: 4px 8px;\n\n    &:first-child {\n      border-top-left-radius: 2px;\n      border-top-right-radius: 2px;\n    }\n\n    &:last-child {\n      border-bottom-right-radius: 2px;\n      border-bottom-left-radius: 2px;\n    }\n\n    &:hover, &[aria-selected=true] {\n      color: #1E2134;\n    }\n  }\n"], ["\n  position: absolute;\n  min-width: 180px;\n  padding: 16px;\n  margin: 20px 0 0;\n  list-style: none;\n  cursor: pointer;\n  background: #fff;\n  border: 1px solid #c8ccd0;\n  border-radius: 3px;\n  box-shadow: 0 1px 5px rgba(27, 31, 35, .15);\n  color: #506176;\n\n  li {\n    padding: 4px 8px;\n\n    &:first-child {\n      border-top-left-radius: 2px;\n      border-top-right-radius: 2px;\n    }\n\n    &:last-child {\n      border-bottom-right-radius: 2px;\n      border-bottom-left-radius: 2px;\n    }\n\n    &:hover, &[aria-selected=true] {\n      color: #1E2134;\n    }\n  }\n"])));
...
var EditorWrapper = styled__default["default"].div(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  display: flex;\n  flex-wrap: wrap;\n  border-top: 1px solid #e2e8f0;\n  border-bottom: 1px solid #e2e8f0;\n  ", ";\n"], ["\n  display: flex;\n  flex-wrap: wrap;\n  border-top: 1px solid #e2e8f0;\n  border-bottom: 1px solid #e2e8f0;\n  ",
    ";\n"])), function (props) {
    return props.theme === "subsquare" && styled.css(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n            border: none;\n          "], ["\n            border: none;\n          "])));
});
var ToolBar = styled__default["default"].div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  flex-basis: 100%;\n  padding-left: 16px;\n  padding-right: 16px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  ", ";\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    display: block;\n    padding-left: 0;\n    padding-right: 0;\n  }\n"], ["\n  flex-basis: 100%;\n  padding-left: 16px;\n  padding-right: 16px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  ",
    ";\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    display: block;\n    padding-left: 0;\n    padding-right: 0;\n  }\n"])), function (props) {
    return props.theme === "subsquare" && styled.css(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n            justify-content: end;\n            background-color: #F6F7FA;\n            padding-left: 0;\n            padding-right: 20px;\n            height: 40px;\n            border-bottom: 1px solid #E0E4EB;\n            position: relative;\n            > div:first-child{\n              gap: 0;\n              height: 40px;\n            }\n          "], ["\n            justify-content: end;\n            background-color: #F6F7FA;\n            padding-left: 0;\n            padding-right: 20px;\n            height: 40px;\n            border-bottom: 1px solid #E0E4EB;\n            position: relative;\n            > div:first-child{\n              gap: 0;\n              height: 40px;\n            }\n          "])));
});
var TabsWrapper = styled__default["default"].div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: flex;\n  gap: 24px;\n  height: 48px;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    border-bottom: 1px solid #E2E8F0;\n  }\n  ", ";\n"], ["\n  display: flex;\n  gap: 24px;\n  height: 48px;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    border-bottom: 1px solid #E2E8F0;\n  }\n  ",
    ";\n"])), function (props) {
    return props.theme === "subsquare" && styled.css(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n            position: absolute;\n            left: 0;\n          "], ["\n            position: absolute;\n            left: 0;\n          "])));
});
var Tab = styled__default["default"].button(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  all: unset;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 24px;\n  border-bottom: 3px solid #ffffff;\n  ", ";\n  ", ";\n  ", ";\n  cursor: pointer;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    margin-left: 16px;\n    margin-right: 16px;\n    width: 50%;\n    text-align: center;\n  }\n"], ["\n  all: unset;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 24px;\n  border-bottom: 3px solid #ffffff;\n  ",
    ";\n  ",
    ";\n  ",
    ";\n  cursor: pointer;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    margin-left: 16px;\n    margin-right: 16px;\n    width: 50%;\n    text-align: center;\n  }\n"])), function (props) {
    return props.theme === "subsquare" && styled.css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n            padding: 12px;\n            line-height: 16px;\n            border-bottom: none;\n            color: #9DA9BB;\n            :last-child{\n              box-shadow: 1px 0 0 0  #E0E4EB;\n            }\n            :hover{\n              color: #506176;\n            }\n          "], ["\n            padding: 12px;\n            line-height: 16px;\n            border-bottom: none;\n            color: #9DA9BB;\n            :last-child{\n              box-shadow: 1px 0 0 0  #E0E4EB;\n            }\n            :hover{\n              color: #506176;\n            }\n          "])));
}, function (props) {
    return props.active && props.theme === "opensquare" && styled.css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n            border-bottom: 3px solid #04d2c5;\n          "], ["\n            border-bottom: 3px solid #04d2c5;\n          "])));
}, function (props) {
    return props.active && props.theme === "subsquare" && styled.css(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n            background-color: white;\n            color: #1E2134;\n            border-bottom: 17px solid white;\n            :first-child{\n              box-shadow: 1px 0 0 0  #E0E4EB;\n            }\n            :last-child{\n              box-shadow: -1px 0 0 0  #E0E4EB, 1px 0 0 0  #E0E4EB;\n            }\n            :hover{\n              color: #1E2134;\n            }\n          "], ["\n            background-color: white;\n            color: #1E2134;\n            border-bottom: 17px solid white;\n            :first-child{\n              box-shadow: 1px 0 0 0  #E0E4EB;\n            }\n            :last-child{\n              box-shadow: -1px 0 0 0  #E0E4EB, 1px 0 0 0  #E0E4EB;\n            }\n            :hover{\n              color: #1E2134;\n            }\n          "])));
});
var ToolbarItemsWrapper = styled__default["default"].div(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  ", ";\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    height: 48px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  ",
    ";\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    height: 48px;\n  }\n"])), function (props) {
    return props.hide && styled.css(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n            display: none;\n          "], ["\n            display: none;\n          "])));
});
var ToolbarButton = styled__default["default"].button(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  all: unset;\n  cursor: pointer;\n  width: 24px;\n  height: 24px;\n\n  &:hover svg path {\n    fill: #1e2134;\n  }\n"], ["\n  all: unset;\n  cursor: pointer;\n  width: 24px;\n  height: 24px;\n\n  &:hover svg path {\n    fill: #1e2134;\n  }\n"])));
var Textarea = styled__default["default"].textarea(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\n  box-sizing: border-box;\n  width: 100%;\n  min-height: 144px;\n  ", " ;\n  ", " ;\n  ", ";\n  max-height: 672px;\n  resize: vertical;\n  border: none;\n  outline: none;\n  font-size: 14px;\n  line-height: 24px;\n  padding: 12px;\n  background: #fbfcfe;\n  ", ";\n  font-family: Inter, sans-serif;\n\n  ::selection {\n    background-color: #E2E8F0;\n  }\n"], ["\n  box-sizing: border-box;\n  width: 100%;\n  min-height: 144px;\n  ",
    " ;\n  ",
    " ;\n  ",
    ";\n  max-height: 672px;\n  resize: vertical;\n  border: none;\n  outline: none;\n  font-size: 14px;\n  line-height: 24px;\n  padding: 12px;\n  background: #fbfcfe;\n  ",
    ";\n  font-family: Inter, sans-serif;\n\n  ::selection {\n    background-color: #E2E8F0;\n  }\n"])), function (props) {
    return props.minHeight && styled.css(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n            min-height: ", "px;\n          "], ["\n            min-height: ", "px;\n          "])), props.minHeight);
}, function (props) {
    return props.height && styled.css(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n            height: ", "px;\n          "], ["\n            height: ", "px;\n          "])), props.height);
}, function (props) {
    return props.hide && styled.css(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n            display: none;\n          "], ["\n            display: none;\n          "])));
}, function (props) {
    return props.theme === "subsquare" && styled.css(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n            background-color: white;\n          "], ["\n            background-color: white;\n          "])));
});
...
var VerticalDivider = styled__default["default"].div(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  width: 1px;\n  height: 40px;\n  background-color: #E0E4EB;\n"], ["\n  width: 1px;\n  height: 40px;\n  background-color: #E0E4EB;\n"])));
var Wrapper$1 = styled__default["default"].div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  ", ";\n"], ["\n  ", ";\n"])), quillStyle);
...
function WYSIWYG(props) {
    ...
    return React__default["default"].createElement(Wrapper$1, { isPreview: isPreview },
        React__default["default"].createElement(StateToggle, null,
            ...
            React__default["default"].createElement("button", { onClick: function () { return setIsPreview(true); }, className: isPreview ? "active" : "" }, "Preview"),
            React__default["default"].createElement(VerticalDivider, null)),
...
var Wrapper = styled__default["default"].div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: relative;\n  cursor: pointer;\n  width: 38px;\n  height: 22px;\n  background: #c2c8d5;\n  border-radius: 16px;\n  > div {\n    width: 14px;\n    height: 14px;\n    position: absolute;\n    top: 4px;\n    left: 4px;\n    background: #ffffff;\n    border-radius: 7px;\n  }\n  ", "\n  ", "\n"], ["\n  position: relative;\n  cursor: pointer;\n  width: 38px;\n  height: 22px;\n  background: #c2c8d5;\n  border-radius: 16px;\n  > div {\n    width: 14px;\n    height: 14px;\n    position: absolute;\n    top: 4px;\n    left: 4px;\n    background: #ffffff;\n    border-radius: 7px;\n  }\n  ",
    ...
    return p.disabled
        ...
        ? styled.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        background: #6848ff;\n        > div {\n          left: auto;\n          right: 4px;\n        }\n      "], ["\n        background: #6848ff;\n        > div {\n          left: auto;\n          right: 4px;\n        }\n      "]))) : null;
}, function (p) {
    return p.size === "small" && styled.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n      width: 30px;\n      height: 18px;\n      > div {\n        width: 12px;\n        height: 12px;\n        top: 3px;\n        left: 3px;\n        border-radius: 6px;\n      }\n      ", "\n    "], ["\n      width: 30px;\n      height: 18px;\n      > div {\n        width: 12px;\n        height: 12px;\n        top: 3px;\n        left: 3px;\n        border-radius: 6px;\n      }\n      ",
        "\n    "])), function (p) {
        return p.active && styled.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n          background: #6848ff;\n          > div {\n            left: auto;\n            right: 3px;\n          }\n        "], ["\n          background: #6848ff;\n          > div {\n            left: auto;\n            right: 3px;\n          }\n        "])));
    });
});
function Toggle(_a) {
    var disabled = _a.disabled, isOn = _a.isOn, onToggle = _a.onToggle, size = _a.size;
    return (React__default["default"].createElement(Wrapper, { disabled: disabled, active: isOn, onClick: function () { return onToggle(!isOn); }, size: size },
...
var UniverseEditor = function () {
    ...
    var _b = React.useState("html"), contentType = _b[0], setContentType = _b[1];
    ...
    return React__namespace.createElement("div", { style: { maxWidth: 800, border: "1px solid #EBEEF4", borderRadius: 4 } },
        contentType === "markdown" ?
            React__namespace.createElement(Editor, { value: content, onChange: function (value) {
                    setContent(value);
                }, suggestions: suggestions, minHeight: 200, theme: "subsquare" })
            :
                React__namespace.createElement(WYSIWYG, { value: htmlContent, onChange: function (value) { return setHtmlContent(value); } }),
...
var Editor = function (_a) {
    ...
    var _d = React.useState({ left: 0, top: 0, lineHeight: 20 }), caret = _d[0], setCaret = _d[1];
    var _e = React__namespace.useState(false), showSuggestion = _e[0], setShowSuggestion = _e[1];
    ...
    var observer;
    var _h = React.useState(100), height = _h[0], setHeight = _h[1];
    var _j = React.useState(false), userResized = _j[0], setUserResized = _j[1];
    ...
    return (React__namespace.createElement(EditorWrapper, { theme: theme },
