...
var previewer = require('@osn/previewer');
...
const PreviewWrapper = styled__default["default"].div `
  min-height: 200px;
  padding: 10px 16px;
`;
...
function WYSIWYG(props) {
    ...
    return (React__default["default"].createElement(Wrapper$2, { isPreview: isPreview, height: (_a = props.minHeight) !== null && _a !== void 0 ? _a : 200 },
        React__default["default"].createElement(StateToggle, null,
            React__default["default"].createElement("button", { onClick: () => setIsPreview(false), className: isPreview ? "" : "active", style: { borderTopLeftRadius: 3 } }, "Write"),
            ...
            React__default["default"].createElement(VerticalDivider, null)),
        React__default["default"].createElement("div", Object.assign({ style: { display: isPreview ? "none" : "initial" } }, properties)),
        isPreview && (React__default["default"].createElement(PreviewWrapper, null,
            React__default["default"].createElement(previewer.HtmlPreviewer, { content: props.value, plugins: [previewer.renderMentionIdentityUserPlugin(props.identifier, { targetElement: { tag: "span" } })] })))));
}
...
function EditorHeader({ theme, editStatus, setEditStatus, isPreview, commandController }) {
    return (React__namespace.createElement(ToolBar, { theme: theme, isPreview: isPreview },
        React__namespace.createElement(TabsWrapper, { theme: theme },
            React__namespace.createElement(Tab, { active: editStatus === "write", onClick: () => setEditStatus("write"), theme: theme, style: { borderTopLeftRadius: 3 } }, "Write"),
...
const Editor = ({ value, onChange, loadSuggestions, minHeight = 144, theme = "opensquare", disabled = false, identifier }) => {
    ...
    return (React__namespace.createElement(EditorWrapper, { theme: themeCSS, disabled: disabled },
        ...
        isPreview && (React__namespace.createElement(PreviewWrapper, null,
            React__namespace.createElement(previewer.MarkdownPreviewer, Object.assign({ content: value }, (identifier
                ? { plugins: [previewer.renderIdentityOrAddressPlugin(identifier)] }
                : {}))))),
...
const UniverseEditor = ({ value, onChange, contentType = "markdown", setContentType, loadSuggestions, disabled = false, minHeight = 200, identifier }) => {
    ...
    return (React__namespace.createElement("div", { style: {
        ...
        contentType === "markdown" ? (React__namespace.createElement(Editor, { value: value, onChange: onChange, loadSuggestions: loadSuggestions, minHeight: minHeight, theme: "subsquare", disabled: disabled, identifier: identifier })) : (React__namespace.createElement(React__namespace.Fragment, null,
            ...
            React__namespace.createElement(WYSIWYG, { value: value, onChange: onChange, setModalInsetFunc: (insetFunc, type) => {
                    setModalType(type);
                    setShowModal(true);
