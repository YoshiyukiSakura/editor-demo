...
var MarkdownPreviewWrapper = styled__default["default"].div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  box-sizing: border-box;\n  flex-basis: 100%;\n  min-height: 144px;\n  background-color: #fbfcfe;\n  padding: 12px;\n\n  .markdown-body {\n    background-color: inherit !important;\n  }\n\n  ", ";\n"], ["\n  box-sizing: border-box;\n  flex-basis: 100%;\n  min-height: 144px;\n  background-color: #fbfcfe;\n  padding: 12px;\n\n  .markdown-body {\n    background-color: inherit !important;\n  }\n\n  ",
    ";\n"])), function (props) {
    return props.minHeight && styled.css(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n            min-height: ", "px;\n          "], ["\n            min-height: ", "px;\n          "])), props.minHeight);
});
...
var SuggestionsWrapper = styled__default["default"].ul(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  position: absolute;\n  min-width: 180px;\n  padding: 8px 0;\n  margin: 20px 0 0;\n  list-style: none;\n  cursor: pointer;\n  background: #fff;\n  box-shadow: 0px 4px 31px rgba(26, 33, 44, 0.06),\n    0px 0.751293px 8px rgba(26, 33, 44, 0.04);\n  color: #506176;\n\n  li {\n    padding: 6px 16px;\n\n    &:hover,\n    &[aria-selected=\"true\"] {\n      background-color: #f0f3f8;\n    }\n  }\n"], ["\n  position: absolute;\n  min-width: 180px;\n  padding: 8px 0;\n  margin: 20px 0 0;\n  list-style: none;\n  cursor: pointer;\n  background: #fff;\n  box-shadow: 0px 4px 31px rgba(26, 33, 44, 0.06),\n    0px 0.751293px 8px rgba(26, 33, 44, 0.04);\n  color: #506176;\n\n  li {\n    padding: 6px 16px;\n\n    &:hover,\n    &[aria-selected=\"true\"] {\n      background-color: #f0f3f8;\n    }\n  }\n"])));
...
var EditorWrapper = styled__default["default"].div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  flex-wrap: wrap;\n  border-top: 1px solid #e2e8f0;\n  border-bottom: 1px solid #e2e8f0;\n  ", "\n"], ["\n  position: relative;\n  display: flex;\n  flex-wrap: wrap;\n  border-top: 1px solid #e2e8f0;\n  border-bottom: 1px solid #e2e8f0;\n  ",
    "\n"])), function (p) {
    return p.disabled && styled.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      pointer-events: none;\n      cursor: not-allowed;\n    "], ["\n      pointer-events: none;\n      cursor: not-allowed;\n    "])));
});
var ToolBar = styled__default["default"].div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  flex-basis: 100%;\n  padding-left: 16px;\n  padding-right: 16px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    display: block;\n    padding-left: 0;\n    padding-right: 0;\n  }\n"], ["\n  flex-basis: 100%;\n  padding-left: 16px;\n  padding-right: 16px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    display: block;\n    padding-left: 0;\n    padding-right: 0;\n  }\n"])));
var TabsWrapper = styled__default["default"].div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: flex;\n  gap: 24px;\n  height: 48px;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    border-bottom: 1px solid #e2e8f0;\n  }\n"], ["\n  display: flex;\n  gap: 24px;\n  height: 48px;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    border-bottom: 1px solid #e2e8f0;\n  }\n"])));
var Tab = styled__default["default"].button(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  all: unset;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 24px;\n  border-bottom: 3px solid #ffffff;\n  ", ";\n  cursor: pointer;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    margin-left: 16px;\n    margin-right: 16px;\n    width: 50%;\n    text-align: center;\n  }\n"], ["\n  all: unset;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 24px;\n  border-bottom: 3px solid #ffffff;\n  ",
    ";\n  cursor: pointer;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    margin-left: 16px;\n    margin-right: 16px;\n    width: 50%;\n    text-align: center;\n  }\n"])), function (props) {
    return props.active && styled.css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      border-bottom: 3px solid #04d2c5;\n    "], ["\n      border-bottom: 3px solid #04d2c5;\n    "])));
});
var ToolbarItemsWrapper = styled__default["default"].div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  ", ";\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    height: 48px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  ",
    ";\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    height: 48px;\n  }\n"])), function (props) {
    return props.hide && styled.css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      display: none;\n    "], ["\n      display: none;\n    "])));
});
var ToolbarButton = styled__default["default"].button(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  all: unset;\n  cursor: pointer;\n  width: 24px;\n  height: 24px;\n\n  &:hover svg path {\n    fill: #1e2134;\n  }\n"], ["\n  all: unset;\n  cursor: pointer;\n  width: 24px;\n  height: 24px;\n\n  &:hover svg path {\n    fill: #1e2134;\n  }\n"])));
var Textarea = styled__default["default"].textarea(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  box-sizing: border-box;\n  width: 100%;\n  min-height: 144px;\n  ", ";\n  ", ";\n  ", ";\n  max-height: 672px;\n  resize: vertical;\n  border: none;\n  outline: none;\n  font-size: 14px;\n  line-height: 24px;\n  padding: 12px;\n  background: #fbfcfe;\n  font-family: Inter, sans-serif;\n\n  ::selection {\n    background-color: #e2e8f0;\n  }\n"], ["\n  box-sizing: border-box;\n  width: 100%;\n  min-height: 144px;\n  ",
    ";\n  ",
    ";\n  ",
    ";\n  max-height: 672px;\n  resize: vertical;\n  border: none;\n  outline: none;\n  font-size: 14px;\n  line-height: 24px;\n  padding: 12px;\n  background: #fbfcfe;\n  font-family: Inter, sans-serif;\n\n  ::selection {\n    background-color: #e2e8f0;\n  }\n"])), function (props) {
    return props.minHeight && styled.css(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n      min-height: ", "px;\n    "], ["\n      min-height: ", "px;\n    "])), props.minHeight);
}, function (props) {
    return props.height && styled.css(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n      height: ", "px;\n    "], ["\n      height: ", "px;\n    "])), props.height);
}, function (props) {
    return props.hide && styled.css(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n      display: none;\n    "], ["\n      display: none;\n    "])));
});
...
var Editor = function (_a) {
    ...
    var _g = React__namespace.useState([]), suggestions = _g[0], setSuggestions = _g[1];
    ...
    var observer;
    var _j = React.useState(100), height = _j[0], setHeight = _j[1];
    var _k = React.useState(false), userResized = _k[0], setUserResized = _k[1];
    ...
    return (React__namespace.createElement(EditorWrapper, { disabled: disabled },
