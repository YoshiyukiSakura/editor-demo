...
var TabsWrapper = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  gap: 24px;\n  height: 48px;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    border-bottom: 1px solid #E2E8F0;\n  }\n"], ["\n  display: flex;\n  gap: 24px;\n  height: 48px;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    border-bottom: 1px solid #E2E8F0;\n  }\n"])));
var Tab = styled.button(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  all: unset;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 24px;\n  border-bottom: 3px solid #ffffff;\n  ", ";\n  cursor: pointer;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    margin-left: 16px;\n    margin-right: 16px;\n    width: 50%;\n    text-align: center;\n  }\n"], ["\n  all: unset;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 24px;\n  border-bottom: 3px solid #ffffff;\n  ",
    ";\n  cursor: pointer;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    margin-left: 16px;\n    margin-right: 16px;\n    width: 50%;\n    text-align: center;\n  }\n"])), function (props) {
    return props.active && css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n            border-bottom: 3px solid #04d2c5;\n          "], ["\n            border-bottom: 3px solid #04d2c5;\n          "])));
});
...
function WYSIWYG(props) {
    ...
    var generation = 0;
    var _a = React__default.useState(null), editingArea = _a[0], setEditingArea = _a[1];
...
var Editor = function (_a) {
    ...
    return (React.createElement(EditorWrapper, null,
        ...
        React.createElement(Textarea, { ref: ref, value: value, onChange: function (event) {
                ...
                adjustHeight();
            }, onKeyDown: handleKeyDown, onKeyPress: handleKeyPress, placeholder: "Please text here...", minHeight: minHeight, height: height, hide: isPreview }),
