...
function MarkdownPreview(props = { minHeight: 144 }) {
    const { content = "", allowedTags = sanitizeHtml.defaults.allowedTags.concat([
        "img",
        "iframe",
        "br",
        "ins",
    ...
    const html = marked.parse(content, {
        ...
        highlight(code, lang) {
            ...
            const language = (_a = Prism.languages[lang]) !== null && _a !== void 0 ? _a : Prism.languages.markup;
    ...
    return (React__default.createElement(MarkdownPreviewWrapper, Object.assign({}, restProps),
...
const SuggestionsDropdown = ({ suggestions, caret, onSuggestionSelected, suggestionsAutoplace, focusIndex, textAreaRef, max = 5 }) => {
    ...
    if (suggestionsAutoplace &&
        ...
        style.left = left;
    return (React.createElement(SuggestionsWrapper, { style: style }, suggestions.slice(0, max).map((s, i) => (React.createElement("li", { onClick: handleSuggestionClick, onMouseDown: handleMouseDown, key: i, "aria-selected": focusIndex === i ? "true" : "false", "data-index": `${i}` }, s.preview)))));
};
...
function EditorHeader({ theme, editStatus, setEditStatus, isPreview, commandController }) {
    return React.createElement(ToolBar, { theme: theme },
        React.createElement(TabsWrapper, { theme: theme },
            React.createElement(Tab, { active: editStatus === "write", onClick: () => setEditStatus("write"), theme: theme }, "Write"),
...
const Embed = Quill__default.import("blots/embed");
...
function WYSIWYG(props) {
    ...
    return (React__default.createElement(Wrapper$2, { isPreview: isPreview },
        React__default.createElement(StateToggle, null,
            React__default.createElement("button", { onClick: () => setIsPreview(false), className: isPreview ? "" : "active" }, "Write"),
            ...
            React__default.createElement(VerticalDivider, null)),
        React__default.createElement("div", Object.assign({}, properties))));
}
...
const UniverseEditor = ({ loadSuggestions }) => {
    ...
    return (React.createElement("div", { style: {
        ...
        contentType === "markdown" ? (React.createElement(Editor, { value: content, onChange: value => {
                setContent(value);
            ...
            React.createElement(WYSIWYG, { value: htmlContent, onChange: value => setHtmlContent(value), setModalInsetFunc: (insetFunc, type) => {
                    setModalType(type);
                    setShowModal(true);
