...
var UniverseEditor = function () {
    var _a = useState(markdown), content = _a[0], setContent = _a[1];
    var _b = useState("markdown"), contentType = _b[0], setContentType = _b[1];
    var _c = useState("<p>\u3000</p>"), htmlContent = _c[0], setHtmlContent = _c[1];
    var _d = useState(false), showModal = _d[0], setShowModal = _d[1];
    var _e = useState("image"), modalType = _e[0], setModalType = _e[1];
    var _f = useState(null), insetQuillContentsFunc = _f[0], setInsetQuillContentsFunc = _f[1];
    ...
    return (React.createElement("div", { style: {
        ...
        contentType === "markdown" ? (React.createElement(Editor, { value: content, onChange: function (value) {
                setContent(value);
            }, suggestions: suggestions, minHeight: 200, theme: "subsquare" })) : (React.createElement(React.Fragment, null,
