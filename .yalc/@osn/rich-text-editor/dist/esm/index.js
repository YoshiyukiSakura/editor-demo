...
var Tab = styled.button(templateObject_11$1 || (templateObject_11$1 = __makeTemplateObject(["\n  all: unset;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 24px;\n  border-bottom: 3px solid #ffffff;\n  ", ";\n  ", ";\n  ", ";\n  cursor: pointer;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    margin-left: 16px;\n    margin-right: 16px;\n    width: 50%;\n    text-align: center;\n  }\n"], ["\n  all: unset;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 24px;\n  border-bottom: 3px solid #ffffff;\n  ",
    ";\n  ",
    ";\n  ",
    ";\n  cursor: pointer;\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    margin-left: 16px;\n    margin-right: 16px;\n    width: 50%;\n    text-align: center;\n  }\n"])), function (props) {
    return props.theme === "subsquare" && css(templateObject_8$1 || (templateObject_8$1 = __makeTemplateObject(["\n            padding: 12px;\n            line-height: 16px;\n            border-bottom: none;\n            color: #9DA9BB;\n            :last-child{\n              box-shadow: 1px 0 0 0  #E0E4EB;\n            }\n            :hover{\n              color: #506176;\n            }\n          "], ["\n            padding: 12px;\n            line-height: 16px;\n            border-bottom: none;\n            color: #9DA9BB;\n            :last-child{\n              box-shadow: 1px 0 0 0  #E0E4EB;\n            }\n            :hover{\n              color: #506176;\n            }\n          "])));
}, function (props) {
    return props.active && props.theme === "opensquare" && css(templateObject_9$1 || (templateObject_9$1 = __makeTemplateObject(["\n            border-bottom: 3px solid #04d2c5;\n          "], ["\n            border-bottom: 3px solid #04d2c5;\n          "])));
}, function (props) {
    return props.active && props.theme === "subsquare" && css(templateObject_10$1 || (templateObject_10$1 = __makeTemplateObject(["\n            background-color: white;\n            color: #1E2134;\n            border-bottom: 17px solid white;\n            :first-child{\n              box-shadow: 1px 0 0 0  #E0E4EB;\n            }\n            :last-child{\n              box-shadow: -1px 0 0 0  #E0E4EB, 1px 0 0 0  #E0E4EB;\n            }\n            :hover{\n              color: #1E2134;\n            }\n          "], ["\n            background-color: white;\n            color: #1E2134;\n            border-bottom: 17px solid white;\n            :first-child{\n              box-shadow: 1px 0 0 0  #E0E4EB;\n            }\n            :last-child{\n              box-shadow: -1px 0 0 0  #E0E4EB, 1px 0 0 0  #E0E4EB;\n            }\n            :hover{\n              color: #1E2134;\n            }\n          "])));
});
var ToolbarItemsWrapper = styled.div(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  ", ";\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    height: 48px;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  ",
    ";\n  /* mobile */\n  @media screen and (max-width: 769px) {\n    height: 48px;\n  }\n"])), function (props) {
    return props.hide && css(templateObject_12$1 || (templateObject_12$1 = __makeTemplateObject(["\n            display: none;\n          "], ["\n            display: none;\n          "])));
});
var ToolbarButton = styled.button(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  all: unset;\n  cursor: pointer;\n  width: 24px;\n  height: 24px;\n\n  &:hover svg path {\n    fill: #1e2134;\n  }\n"], ["\n  all: unset;\n  cursor: pointer;\n  width: 24px;\n  height: 24px;\n\n  &:hover svg path {\n    fill: #1e2134;\n  }\n"])));
var Textarea = styled.textarea(templateObject_19 || (templateObject_19 = __makeTemplateObject(["\n  box-sizing: border-box;\n  width: 100%;\n  min-height: 144px;\n  ", " ;\n  ", " ;\n  ", ";\n  max-height: 672px;\n  resize: vertical;\n  border: none;\n  outline: none;\n  font-size: 14px;\n  line-height: 24px;\n  padding: 12px;\n  background: #fbfcfe;\n  ", ";\n  font-family: Inter, sans-serif;\n\n  ::selection {\n    background-color: #E2E8F0;\n  }\n"], ["\n  box-sizing: border-box;\n  width: 100%;\n  min-height: 144px;\n  ",
    " ;\n  ",
    " ;\n  ",
    ";\n  max-height: 672px;\n  resize: vertical;\n  border: none;\n  outline: none;\n  font-size: 14px;\n  line-height: 24px;\n  padding: 12px;\n  background: #fbfcfe;\n  ",
    ";\n  font-family: Inter, sans-serif;\n\n  ::selection {\n    background-color: #E2E8F0;\n  }\n"])), function (props) {
    return props.minHeight && css(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n            min-height: ", "px;\n          "], ["\n            min-height: ", "px;\n          "])), props.minHeight);
}, function (props) {
    return props.height && css(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n            height: ", "px;\n          "], ["\n            height: ", "px;\n          "])), props.height);
}, function (props) {
    return props.hide && css(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n            display: none;\n          "], ["\n            display: none;\n          "])));
}, function (props) {
    return props.theme === "subsquare" && css(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\n            background-color: white;\n          "], ["\n            background-color: white;\n          "])));
});
...
function getHandlers(_a) {
    ...
    var handleSuggestionSelected = function (index) {
        if (loadSuggestions) {
            ref.current.setSelectionRange(mentionState.startPosition, ref.current.selectionStart);
